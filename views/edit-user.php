    ...
    <?php session_start(); ?>
      <nav class="navbar navbar-expand-md navbar-dark bg-dark px-4">
        ...
        <ul class="navbar-nav ms-auto">
          <li class="nav-item"><a href="" class="text-muted text-decoration-none me-3"><?= $_SESSION['username'] ?></a></li>
          <li class="nav-item"><a href="" class="text-danger text-decoration-none ">Log out</a></li>
        </ul>
      </nav>
